...
export async function getStaticProps() {
  ...
  // Validate data
  const tvshowArray = Array.isArray(tvshowData) ? tvshowData : [];
  return {
    props: {
      tvshowData: tvshowArray,
    },
  };
}
...
export default function tvshow({ tvshowData }) {
  ...
  const currenttvshowItems = tvshowData.slice(
    ...
    "@graph": [
      {
        ...
        name: "Movies & Tv Shows™ – Tv Show Section.",
        url: "https://moviesandtvshows.vercel.app/",
      },
      {
        "@type": "WebSite",
        "@id": "https://moviesandtvshows.vercel.app/tvshow#website",
        url: "https://moviesandtvshows.vercel.app/tvshow",
        name: "Movies & Tv Shows™ – Tv Show Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://moviesandtvshows.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://moviesandtvshows.vercel.app/tvshow#webpage",
        url: "https://moviesandtvshows.vercel.app/tvshow",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://moviesandtvshows.vercel.app/tvshow",
            url: "https://moviesandtvshows.vercel.app/tvshow",
        ...
        sameAs: [
          ...
          "https://twitter.com/tvshow24",
          "https://www.youtube.com/@News24thinkfirst",
          "https://www.instagram.com/tvshow24official/",
        ],
      },
    ],
  });
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://moviesandtvshows.vercel.app/tvshow#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://moviesandtvshows.vercel.app/tvshow"],
          },
        ],
      },
      {
        ...
        width: 1280,
        height: 720,
        caption: "Movies & Tv Shows™ – Tv Show Section",
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://moviesandtvshows.vercel.app/tvshow#breadcrumb",
        itemListElement: [
          {
            ...
            position: 1,
            name: "tvshow",
            item: "https://moviesandtvshows.vercel.app/tvshow",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> Movies & Tv Shows™ – Tv Show Section.</title>
        ...
        <meta
          ...
          content="Stream HD movies and TV series for free on Movies & Tv Shows™. Explore, stream, and download full-length movies and shows in HD quality without registration."
        />
        <link rel="canonical" href="https://moviesandtvshows.vercel.app/tvshow" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" Movies & Tv Shows™ – Tv Show Section. "
        />
        <meta
          property="og:url"
          content="https://moviesandtvshows.vercel.app/tvshow"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>Movies & Tv Shows™ Tv Show Section.</h1>
        <div style={styles.dateTime}>
          ...
          >
           <h2>Latest Tv Show Updated Engilsh & Hindi & Others.</h2>
          </div>
        </div>
        {/* Pagination Controls */}
        ...
        <ul style={styles.newsList}>
          {currenttvshowItems.map((tvshowItem, index) => (
            <li key={index} style={styles.tvshowItem}>
                <Link
                href={`/tvshow/${generateSlug(tvshowItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={tvshowItem.image1 || tvshowItem.image}
