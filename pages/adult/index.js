...
export default function adult({ adultData }) {
    ...
    "@graph": [
      ...
      },
      {
        ...
        sameAs: [
          ...
          "https://twitter.com/adult24",
          "https://www.youtube.com/@News24thinkfirst",
          "https://www.instagram.com/adult24official/",
        ],
      },
    ],
  });
  ...
  return (
    <>
      <Head>
        <title> Movies & Tv Shows™ – Adult Section.</title>
        ...
        <meta
          property="og:title"
          content=" Movies & Tv Shows™ – Adult Section. "
        />
        <meta
          property="og:url"
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>Movies & Tv Shows™ Adult Section.</h1>
        ...
        <div style={styles.dateTime}>
          ...
          >
           <h2>This Content is Strickly for Adults Only.</h2>
          </div>
        </div>
        {/* Pagination Controls */}
        ...
        <ul style={styles.newsList}>
          {currentadultItems.map((adultItem, index) => (
            <li key={index} style={styles.adultItem}>
              <Link
                href={`/adult/${generateSlug(adultItem.title)}`}
