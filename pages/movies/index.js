...
export default function movies({ moviesData }) {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://moviesntvshows.netlify.app/movies#website",
        url: "https://moviesntvshows.netlify.app/movies",
        name: "Movies & Tv Shows™ – Movies Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://moviesntvshows.netlify.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://moviesntvshows.netlify.app/movies#webpage",
        url: "https://moviesntvshows.netlify.app/movies",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://moviesntvshows.netlify.app/movies",
            url: "https://moviesntvshows.netlify.app/movies",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://moviesntvshows.netlify.app/movies#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://moviesntvshows.netlify.app/movies"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "movies",
            item: "https://moviesntvshows.netlify.app/movies",
          },
        ],
      },
      {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="Stream HD movies and TV series for free on Movies & Tv Shows™. Explore, stream, and download full-length movies and shows in HD quality without registration."
        />
        <link rel="canonical" href="https://moviesntvshows.netlify.app/movies" />
        ...
        <meta
          property="og:url"
          content="https://moviesntvshows.netlify.app/movies"
        />
        <meta
